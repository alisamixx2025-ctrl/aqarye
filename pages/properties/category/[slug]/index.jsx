...
const CategoryPropertiesPage = ({ seoData, pageName, slug }) => {
    ...
    const metaTitle = categorySlugName
        ? `${formattedCategoryName} Properties - ${process.env.NEXT_PUBLIC_META_TITLE || 'Yemen Aqar'}`
        : `Category Properties - ${process.env.NEXT_PUBLIC_META_TITLE || 'Yemen Aqar'}`; // Fallback title
