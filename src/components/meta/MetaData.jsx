...
const MetaData = ({
  ...
  const safeTitle = title || process.env.NEXT_PUBLIC_META_TITLE || 'Yemen Aqar';
  ...
  const safeAuthor = author || process.env.NEXT_PUBLIC_APP_NAME || 'Yemen Aqar';
  ...
  const safeSiteName = siteName || process.env.NEXT_PUBLIC_META_TITLE || 'Yemen Aqar';
